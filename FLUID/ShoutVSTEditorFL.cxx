...
ShoutVSTEditorFL::ShoutVSTEditorFL() {
  ...
  { fl_window = new Fl_Double_Window(677, 480);
    ...
    { group_encoding = new Fl_Group(10, 270, 280, 130, "Encoding:");
      ...
      { Fl_Group* o = new Fl_Group(30, 350, 180, 40);
        ...
        { radio_flac = new Fl_Round_Button(155, 355, 45, 30, "flac");
          radio_flac->type(102);
          radio_flac->down_box(FL_ROUND_DOWN_BOX);
          radio_flac->when(FL_WHEN_CHANGED);
        } // Fl_Round_Button* radio_flac
        o->end();
      } // Fl_Group* o
      group_encoding->end();
